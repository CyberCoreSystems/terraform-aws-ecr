...
[![IaC Bazaar: live-tested](https://www.iac-bazaar.com/api/artifacts/aws-ecr/badge)](https://www.iac-bazaar.com/catalog/aws-ecr?utm_source=syndication&utm_medium=readme&utm_campaign=artifact)
...
```
curl -s https://www.iac-bazaar.com/api/artifacts/aws-ecr/verification
```

The receipt names every check that ran, when it ran, and the SHA-256 of the
archive it describes. Full detail: [www.iac-bazaar.com/catalog/aws-ecr](https://www.iac-bazaar.com/catalog/aws-ecr)

## Usage

```hcl
module "ecr" {
  source  = "registry.terraform.io/CyberCoreSystems/ecr/aws"
  version = "~> 1.0"
...
- Terraform module 1.0.0, live-tested on IaC Bazaar: [ECR Repository](https://www.iac-bazaar.com/catalog/aws-ecr?utm_source=syndication&utm_medium=readme&utm_campaign=artifact)
